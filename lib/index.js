...
var APP_SECRET = (process.env.APP_SECRET) || "test", VALIDATION_TOKEN = (process.env.MESSENGER_VALIDATION_TOKEN) || "test", PAGE_ACCESS_TOKEN = (process.env.FB_PAGE_ACCESS_TOKEN) || "test", SERVER_URL = (process.env.SERVER_URL) || "test";
var app = express();
