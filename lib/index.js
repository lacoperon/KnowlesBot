...
*/
'use strict';
var bodyParser = require('body-parser'), express = require('express'), https = require('https'), request = require('request'), messenger = require('./messenger');
var app = express();
...
function parseQuickReply(quickReply) {
    return 0;
}
// Start server
