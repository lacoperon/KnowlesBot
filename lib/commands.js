...
exports.CommandList = {
    ...
    commands: { "babadook": {
            ...
            "do": function (messageText, sender) {
                messenger_1.sendTextMessage(sender, "You now have Music/Video Privileges!");
        ...
        "darmok": {
            ...
            is_secret: true,
            "do": function (messageText, sender) {
                messenger_1.sendTextMessage(sender, "You now have Admin Privileges!");
        ...
        "forget": {
            ...
            is_secret: false,
            "do": function (messageText, sender) {
                messenger_1.sendTextMessage(sender, "Consider yourself forgotten!");
                ...
                for (var commandIndex in listOfCommands) {
                    ...
                    if (exports.CommandList.commands[command] && exports.CommandList.commands[command].description) {
                        ...
                        if (helpDocs.length > 500) {
                            messenger_1.sendTextMessage(sender, helpDocs);
                            helpDocs = '';
                        }
                    }
                }
                ...
                client.get(messenger_1.toState(sender), function (err, reply) {
                    if (!err) {
                        if (reply != null) {
                            ...
                            if (reply == "default") {
                                messenger_1.sendTextMessage(sender, "Welcome back, friend! Remember you can type 'help' to see an updated list of commands");
                            }
                            else if (reply == "new") {
                                messenger_1.sendTextMessage(sender, "Welcome, newcomer! Type 'help' to see a list of commands");
                    ...
                    if (!err) {
                        if (reply != null) {
                            switch (reply.trim().toLowerCase()) {
                                ...
                                case "admin":
                                    {
                                        messenger_1.sendTextMessage(sender, "Sorry DJ, Music isn't yet implemented");
                                    }
                                    break;
                                case "user":
                                default:
                                    {
                                        messenger_1.sendTextMessage(sender, "Sorry, you don't have music privileges");
                                    }
                                    break;
                            }
                        }
        ...
        "pleb": {
            ...
            is_secret: true,
            "do": function (messageText, sender) {
                messenger_1.sendTextMessage(sender, "You have been demoted to pleb status");
                messenger_1.setRights(sender, "user");
            }
        },
        "wesley": {
                    ...
                    if (!err) {
                        ...
                        client.get(messenger_1.toRights(sender), function (err, reply) {
                            if (!err) {
                                ...
                                messenger_1.sendTextMessage(sender, "You have \nRole: " + position + ",\nState: " + state + ",\nSender ID " + sender.id);
                            }
                        });
                    }
                });
