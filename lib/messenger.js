...
function sendHelpMessage(sender) {
    ...
    var messageTextAdmin = "Admin Commands:\n\n    darmok   : sets oneself as admin (good episode!!\n    babadook: sets oneself as DJ (play music/video as you pleasep\n    pleb    : demotes oneself to pleb status (no more admin/DJ accesss\neccaJ D/niadmore )(no m) ustats bpleto  flesones etome: d    belp\n    leaseou yas  oevid/icusm yapl)() JDs  afleweno s set : kodobaba\n      pod go)() nimdaas self ones t se: kodarm     \n\n      ";
    var messageData = {
        recipient: {
            id: sender.id
        },
